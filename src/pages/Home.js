...
import flatSharing from '../assets/images/home_flat.svg';
import roomSharing from '../assets/images/home_room.svg';
import entairFlat from '../assets/images/home_entire.svg';
                ...
                <div className='layout-search'>
                    <div className="layout-search-first d-flex gap-3 justify-content-center align-items-center">
                        <div className="form-check form-check-inline  p-0 m-0">
                            <input className="form-check-input d-none" type="radio" name="propertyType" id="flatSharing" value="flat" checked />
                            <label className="form-check-label d-flex align-items-center gap-2 text-light border-bottom" for="flatSharing">
                                <img src={flatSharing} alt="Flat Sharing" width="16" height="16" />
                                Flat Sharing
                            </label>
                        </div>

                        <div className="form-check form-check-inline  p-0 m-0">
                            <input className="form-check-input d-none" type="radio" name="propertyType" id="roomSharing" value="room" />
                            <label className="form-check-label d-flex align-items-center gap-2 text-secondary border-bottom" for="roomSharing">
                                <img src={roomSharing} alt="Room Sharing" width="16" height="16" />
                                Room Sharing
                            </label>
                        </div>

                        <div className="form-check form-check-inline p-0 m-0">
                            <input className="form-check-input d-none" type="radio" name="propertyType" id="entireFlat" value="entire" />
                            <label className="form-check-label d-flex align-items-center gap-2 text-secondary border-bottom" for="entireFlat">
                                <img src={entairFlat} alt="Entire Flat" width="16" height="16" />
                                Entire Flat
                            </label>
                        </div>
                    </div>
